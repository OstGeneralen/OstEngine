...
ost::Matrix4x4 ost::Matrix4x4::OrthographicProjection( const Vector3f& aMin, const Vector3f& aMax )
{
    ...
    Matrix4x4 projMat;
    DirectX::XMMATRIX matrix = DirectX::XMMatrixOrthographicLH( size.X, size.Y, aMin.Z, aMax.Z );
...
ost::Matrix4x4 ost::Matrix4x4::PerspectiveProjection( Float32 aAspect, Radians aFov, Float32 aNearPlaneDistance,
