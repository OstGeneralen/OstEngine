...
namespace ost
{
    ...
    using Bytes = bytesizeInternal::TByteSize<1u>;
    using Kilobytes = bytesizeInternal::TByteSize<Bytes::BytesPerUnit * 1024>;
    using Megabytes = bytesizeInternal::TByteSize<Kilobytes::BytesPerUnit * 1024>;
    using Gigabytes = bytesizeInternal::TByteSize<Megabytes::BytesPerUnit * 1024>;
} // namespace ost
