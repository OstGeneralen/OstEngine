...
namespace ost
{
    ...
    template <>
    static bool operator==<Float32>( const TVector2<Float32>& aFirst, const TVector2<Float32>& aSecond );

    template <>
    static bool operator== <Float64>( const TVector2<Float64>& aFirst, const TVector2<Float64>& aSecond );
